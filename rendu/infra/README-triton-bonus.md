# 🏗️ BONUS — Déploiement Triton Inference Server (Docker)

Alternative avancée au déploiement Ollama, via **Triton Inference Server** + backend **Python**.
...
- Ollama reste le déploiement **principal** ; Triton est le bonus.
